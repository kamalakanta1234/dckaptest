            ...
            <div class="row no-gutters">
                ...
                <div class="col-xl-8 col-lg-8 flex-v-center ">
                    <div class="form-area bg-yellow white ">
                      <h2 class="f-700 mb-15 text-white">Edit User</h2>
        ...
        $(this).remove(); 
                        ...
                        <form action="<?php echo base_url();?>users/user_registration" id="userregistration" method="post" enctype="multipart/form-data">
                            ...
                            <div class="  col form-group relative mb-25 mb-sm-20">
                                 <span class="titl">Youe Name</span><input type="text" class="form-control bg-white input-lg input-white shadow-5" name="fname" id="fname" value="<?php echo $user[0]['user_full_name']?>" placeholder="First Name">
                                <span style="color: #fff;"><?php echo form_error('fname') ?></span>
                            </div>
                            
                             <div class="  col form-group relative mb-25 mb-sm-20">
                                <span class="titl">UserName</span> <input type="text" class="form-control bg-white input-lg input-white shadow-5" name="user_name" id="user_name" value="<?php echo $user[0]['user_name']?>"id="name" placeholder="user name">
                        ...
                        <div class="row">
                             <div class="col form-group relative mb-25 mb-sm-20">
                                ...
                                <img src="<?php echo base_url();?>uploads/<?php echo $user[0]['user_profile_image']?>" width="100px" height="100px">
                                <!-- <input type="file" value="<?php echo $user[0]['user_profile_image']?>" name="profile_image"><span> If want to change profile then please choose file</span> -->
                            </div>
                        ...
                        <div class="row">
                            <div class="  col form-group relative mb-25 mb-sm-20">
                               <span class="titl">D-O-B</span> <input type="date" class="form-control bg-white input-lg input-white shadow-5" name="date" id="date" id="date" placeholder="DOB" value="<?php echo $user[0]['user_dob'];?>">
                                <span style="color: #fff;"><?php echo form_error('date') ?></span>
                            </div>
                            <div class="  col-md-6 form-group relative mb-25 mb-sm-20">
                                <span class="titl">Address</span> <input type="text" class="form-control bg-white input-lg input-white shadow-5" name="address" id="address" value="<?php echo $user[0]['user_address']?>" placeholder="Adress ">
                        ...
                        <div class="row">
                             ...
                             <div class="  col form-group relative mb-25 mb-sm-20">
                                 <span class="titl">Mobile Number</span><input type="text" class="form-control bg-white input-lg input-white shadow-5" name="mobile" id="mobile" maxlength="10" value="<?php echo $user[0]['user_mobile']?>"id="name" placeholder="Mobile No.">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group relative mb-25 mb-sm-20">
                                <span class="titl">Email</span> <input type="email" class="form-control bg-white input-lg input-white shadow-5" name="email" value="<?php echo $user[0]['user_email']?>" id="email" placeholder="Email">
                                <span style="color: #fff;"><?php echo form_error('email') ?></span>
                            </div>
                            
                              <input type="text" value="<?php echo $user[0][user_id];?>" name="id_user" id="id_user" hidden>
